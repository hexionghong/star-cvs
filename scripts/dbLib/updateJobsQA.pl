...
my @nohftpath = ();
 ...
 $hftpath[2] = "/star/rcf/test/dev/daq_sl302.ittf/".$beforeDay."/year_2014/AuAu200_production_low_2014";
 $hftpath[3] = "/star/rcf/test/dev/daq_sl302.ittf_opt/".$beforeDay."/year_2014/AuAu200_production_low_2014";
...
#########
  ...
  for ($ii = 0; $ii < $np; $ii++ ){
      ...
      print "Ratio for number of tracks  ",$avgRatio_Trck[$ii], "\n";
...
#      print "Ratio for number of tracks  ",$avgRatio_Trckn15[$ii], "\n";
...
#      print "Ratio for number of tracks  ",$avgRatio_Prim[$ii], "\n";
...
#      print "Ratio for number of tracks  ",$avgRatio_Primn15[$ii], "\n";
