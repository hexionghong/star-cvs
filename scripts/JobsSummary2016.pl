...
# L.Didenko
#
# JobsSummary2016.pl - summary of production jobs status for run 2015
#
########################################################################################
...
########## 
 ...
 if( $daydif <= 2){
     ...
     print HTML "<td HEIGHT=10><h3><font color=\"red\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2016;pflag=jstat\">$jbcrsh[$nprod]</font></h3></td>\n";
     print HTML "<td HEIGHT=10><h3><font color=\"red\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2016;pflag=crserr\">$jberror[$nprod]</font></h3></td>\n";
     print HTML "<td HEIGHT=10><h3><font color=\"red\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2016;pflag=hpss\">$jbhpss[$nprod]</font></h3></td>\n";
     print HTML "<td HEIGHT=10><h3><font color=\"red\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2016;pflag=mudst\">$mismudst[$nprod]</font></h3></td>\n";
     ...
     print HTML "<td HEIGHT=10><h3><font color=\"red\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2016;pflag=strcpu\">$avcpu[$nprod]</font></h3></td>\n";
     print HTML "<td HEIGHT=10><h3><font color=\"red\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2016;pflag=sttrack\">$avgtrk[$nprod]</font></h3></td>\n";
     ...
     print HTML "</TR>\n";
       ...
       print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2016;pflag=jstat\">$jbcrsh[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2016;pflag=crserr\">$jberror[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2016;pflag=hpss\">$jbhpss[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2016;pflag=mudst\">$mismudst[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3>$jbmudst[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3>$sumevt[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2016;pflag=strcpu\">$avcpu[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2016;pflag=sttrack\">$avgtrk[$nprod]</h3></td>\n";
...
print HTML "<html>\n";
print HTML "    <head>\n";
print HTML "          <title>Summary of production jobs for run 2016</title>\n"; 
print HTML "    </head>\n";
print HTML "   <body BGCOLOR=\"cornsilk\">\n";
print HTML " <h2 ALIGN=CENTER> <B>Summary of production jobs status for<font color=\"blue\"> run 2016 </font>data  </B></h2>\n";
