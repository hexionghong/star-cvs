...
# L.Didenko
#
# JobsSummary2018.pl - summary of production jobs status for run 2018
#
########################################################################################
...
my $jobs_html = "/star/u/starlib/datsum/JobSummary2018.html";
...
########## 
 ...
 if( $daydif <= 2){
     ...
     print HTML "<td HEIGHT=10><h3><font color=\"red\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2018;pflag=jstat\">$jbcrsh[$nprod]</font></h3></td>\n";
     print HTML "<td HEIGHT=10><h3><font color=\"red\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2018;pflag=crserr\">$jberror[$nprod]</font></h3></td>\n";
     print HTML "<td HEIGHT=10><h3><font color=\"red\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2018;pflag=hpss\">$jbhpss[$nprod]</font></h3></td>\n";
     print HTML "<td HEIGHT=10><h3><font color=\"red\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2018;pflag=mudst\">$mismudst[$nprod]</font></h3></td>\n";
     ...
     print HTML "<td HEIGHT=10><h3><font color=\"red\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2018;pflag=strcpu\">$avcpu[$nprod]</font></h3></td>\n";
     print HTML "<td HEIGHT=10><h3><font color=\"red\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2018;pflag=sttrack\">$avgtrk[$nprod]</font></h3></td>\n";
     ...
     print HTML "</TR>\n";
       ...
       print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2018;pflag=jstat\">$jbcrsh[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2018;pflag=crserr\">$jberror[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2018;pflag=hpss\">$jbhpss[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2018;pflag=mudst\">$mismudst[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3>$jbmudst[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3>$sumevt[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2018;pflag=strcpu\">$avcpu[$nprod]</h3></td>\n";
       print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2018;pflag=sttrack\">$avgtrk[$nprod]</h3></td>\n";
...
print HTML "<!-- Created: Tue January 15, 2019 -->\n";
print HTML "<!-- hhmts start -->\n";
print HTML "Last modified: 2019-01-15\n";
