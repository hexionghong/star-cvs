...
#        if( $prod[$nlist] eq "P12id" and $trig[$nlist] eq "UU_production_2012" ) {
 ...
 print HTML "<td HEIGHT=10><h3><font color=\"#ff0000\"><a href=\"http://www.star.bnl.gov/devcgi/RetriveChain.pl?trigs=$trig[$nlist];prod=$prod[$nlist]\">$prod[$nlist]</font></h3></td>\n";
 ...
 print HTML "</TR>\n";
    ...
    print HTML "<td HEIGHT=10><h3><a href=\"http://www.star.bnl.gov/devcgi/RetriveChain.pl?trigs=$trig[$nlist];prod=$prod[$nlist]\">$prod[$nlist]</h3></td>\n";
