...
my $prodname = "n/a";
 ...
 $nstr = 0;
   ...
   $fileC->clear_context( );
    ...
    $fileC->set_context("trgsetupname=$trig[$nlist]","production=$prod[$nlist]","sname2=$nstreams[$kk]","filetype=daq_reco_MuDst","storage=local","sanity=1","limit=0" );
...
sub beginHtml {
 ...
 print HTML " <TD ALIGN=CENTER WIDTH=\"10%\" HEIGHT=60><B><h3>Size of MuDst on DD (GB)<h3></B></TD>\n";
 print HTML " <TD ALIGN=CENTER WIDTH=\"10%\" HEIGHT=60><B><h3>Number of MuDst files on DD<h3></B></TD>\n";
 print HTML " <TD ALIGN=CENTER WIDTH=\"10%\" HEIGHT=60><B><h3>Number of MuDst files on HPSS<h3></B></TD>\n";
