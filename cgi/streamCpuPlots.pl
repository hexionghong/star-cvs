...
END
   ...
   print "<p>";
    print "</td><td>";
    print "<h3 align=center> Average CPU, Realtime/CPU, <br> time of jobs execution ,<br> average number of tracks per event,<br> stream job ratios <br>number of stream jobs</h3>";
    print "<h4 align=center>";
