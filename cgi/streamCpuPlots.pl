...
END
   ...
   print "<p>";
    print "</td><td>";
    print "<h3 align=center> Select stream jobs  values: <br> CPU, rtime/CPU, <br>jobs total time on the farm,<br> avg number of tracks,<br> stream rate per finish time interval</h3>";
    print "<h4 align=center>";
