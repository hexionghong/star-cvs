...
print <<END;
  ...
  <html>
   <body BGCOLOR=\"cornsilk\">
<h2 ALIGN=CENTER> <B>List of jobs failed to create output files on NFS in <br> <font color="blue">$qtrg </font>  dataset <br><font color="blue">$qprod</font> production  with <font color="blue">$qreq </font> requestID </B></h2>
 <h3 ALIGN=CENTER> Created on $todate</h3>
<br>
<TABLE ALIGN=CENTER BORDER=5 CELLSPACING=1 CELLPADDING=2 bgcolor=\"#ffdc9f\">
<TR>
