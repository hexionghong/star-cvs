...
if( defined($dest) ){
	...
	"to recover from HPSS. This is NOT a submission script.<br>\n",
        "<b>This cgi will function <font size=\"+1\">only</font> based on files the ",
        "<font size=\"+1\">FastOffline</font></b> system <b>knows</b> about\n",
