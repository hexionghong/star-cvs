...
my $nprod = 0;
  ...
  $outsize[$nprod] = int($outsize[$nprod]/1000000 + 0.5); 
...
<TD ALIGN=CENTER WIDTH=\"5%\" HEIGHT=60><B><h3>No.of files </h3></B></TD>
<TD ALIGN=CENTER WIDTH=\"5%\" HEIGHT=60><B><h3>Size of output files in MB</h3></B></TD>
