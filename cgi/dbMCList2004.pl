...
#  
#
#  dbMCList2004.pl  script to get browser of MC dataset and create WEB page 
#  L. Didneko
#
###############################################################################
...
$mCol = $query->param('setC');
$mEvt = $query->param('evGen');
$mGeo = $query->param('gYear');
...
print $query->start_html('List of MC Datasets');
 ...
 print $query->startform(-action=>"dbMCProdSum2004.pl");
