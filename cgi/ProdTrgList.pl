...
<br>
<h4 ALIGN=LEFT>Link under the trigger set name has stream data production summary </h4> <h4 ALIGN=RIGHT><font color="#ff0000">Ongoing production is in red color</font></h4><br>
<h4  ALIGN=LEFT>Link under production tag has chain options</h4>
