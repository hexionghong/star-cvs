...
<td HEIGHT=10><h3><a href="http://www.star.bnl.gov/devcgi/RetriveTrigID.pl?rtrig=$trig[$nlist];rprod=$prod[$nlist]">triggerID</h3></td>
</TR>
END
...
<h4 ALIGN=RIGHT><h4><font color="#ff0000">Ongoing production is in red color</font></h4>
...
<TD ALIGN=CENTER WIDTH=\"5%\" HEIGHT=60><B><h3>TriggerIDs summary <h3></B></TD>
</TR> 
   </head>
    </body>
END
