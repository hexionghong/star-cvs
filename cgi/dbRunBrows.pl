...
$sql="SELECT * FROM $FileCatalogT WHERE runID = '$runPr' AND fName like '%$frSet' AND site like '$lcSet%' order by fileSeq ";

}else{

$sql="SELECT * FROM $FileCatalogT WHERE runID = '$runPr' AND jobID like '%$prodSr%' AND fName like '%$frSet' AND site like '$lcSet%' order by fileSeq  ";
