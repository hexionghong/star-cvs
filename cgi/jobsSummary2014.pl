...
my $nprod = 0;
  ...
  $sql="SELECT distinct trigsetName, prodSeries, date_format(min(createTime), '%Y-%m-%d') as mintm, date_format(max(createTime), '%Y-%m-%d') as maxtm, sum(NoEvents), avg(CPU_per_evt_sec), avg(avg_no_tracks) from $JobStatusT where createTime <> '0000-00-00 00:00:00' and prodSeries = 'P16id' group by trigsetName, prodSeries order by max(createTime) ";
...
########## 
  ...
  $sql="SELECT count(jobfileName)  FROM $JobStatusT trigsetName  = '$artrg[$nprod]' and prodSeries = '$prodtag[$nprod]' and jobStatus <> 'n/a' and outputHpssStatus = 'n/a' ";
...
<td HEIGHT=10><h3><font color="red"><a href="http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2014;pflag=jstat">$jbcrsh[$nprod]</font></h3></td>
<td HEIGHT=10><h3><font color="red"><a href="http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2014;pflag=crserr">$jberror[$nprod]</font></h3></td>
<td HEIGHT=10><h3><font color="red"><a href="http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2014;pflag=hpss">$jbhpss[$nprod]</font></h3></td>
<td HEIGHT=10><h3><font color="red">$jbresub[$nprod]</font></h3></td>
<td HEIGHT=10><h3><font color="red"><a href="http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2014;pflag=mudst">$mismudst[$nprod]</font></h3></td>
<td HEIGHT=10><h3><font color="red">$jbmudst[$nprod]</font></h3></td>
<td HEIGHT=10><h3><font color="red">$sumevt[$nprod]</font></h3></td>
<td HEIGHT=10><h3><font color="red"><a href="http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2014;pflag=strcpu">$avcpu[$nprod]</font></h3></td>
<td HEIGHT=10><h3><font color="red"><a href="http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2014;pflag=sttrack">$avgtrk[$nprod]</font></h3></td>
...
<td HEIGHT=10><h3><a href="http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2014;pflag=jstat">$jbcrsh[$nprod]</h3></td>
<td HEIGHT=10><h3><a href="http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2014;pflag=crserr">$jberror[$nprod]</h3></td>
<td HEIGHT=10><h3><a href="http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2014;pflag=hpss">$jbhpss[$nprod]</h3></td>
<td HEIGHT=10><h3>$jbresub[$nprod]</h3></td>
<td HEIGHT=10><h3><a href="http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2014;pflag=mudst">$mismudst[$nprod]</h3></td>
<td HEIGHT=10><h3>$jbmudst[$nprod]</h3></td>
<td HEIGHT=10><h3>$sumevt[$nprod]</h3></td>
<td HEIGHT=10><h3><a href="http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2014;pflag=strcpu">$avcpu[$nprod]</h3></td>
<td HEIGHT=10><h3><a href="http://www.star.bnl.gov/devcgi/RetriveJobStat.pl?trigs=$artrg[$nprod];prod=$prodtag[$nprod];pyear=2014;pflag=sttrack">$avgtrk[$nprod]</h3></td>
...
print <<END;
  ...
  <html>
    <head>
          <title>Summary of production jobs for run 2014</title> 
    </head>
   <body BGCOLOR=\"cornsilk\">
 <h2 ALIGN=CENTER> <B>Summary of production jobs status for<font color="blue"> run 2014 </font>data  </B></h2>
